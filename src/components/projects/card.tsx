  ...
  return (
    <div>
      ...
      <div className="flex gap-2 items-end">
        <div className="grid grid-cols-1 gap-3 w-full h-full pb-6 border-secondary/10 sm:pb-5 border-b">
          <Link
            href={props.projectURL}
            target="_blank"
            style={{ opacity: 1 }}
            className="flex items-center gap-2 sm:text-[13px] text-[13px] xs:text-[12px]"
          >
            <span>
              <svg
                width="13"
          ...
          <p className="sm:text-base text-secondary text-[12.5px] xs:text-sm">
            {props.projectInfo}
          </p>
          {/* Card Image */}
